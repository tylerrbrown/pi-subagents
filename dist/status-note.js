 ...
 */
export function getStatusNote(status, stopReason) {
    switch (status) {
        case "stopped":
 ...
 */
export function getForegroundOutcomeNote(status, stopReason) {
    switch (status) {
        case "stopped":
 ...
 */
const OVERLOAD_PATTERN = /\boverload(ed|ing)?|\brate[ _-]?limit|\b429\b|\b503\b|too many requests|service unavailable/i;
/**
 ...
 */
export function getFailureNote(kind) {
 ...
 */
export function partialOutputSuffix(record) {
